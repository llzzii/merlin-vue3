...
const exportExcel = function (luckysheet: any[], value: any) {
  ...
  luckysheet.forEach(function (table: {
    ...
    config: { merge: any; borderInfo: any };
  }) {
...
const setMerge = function (luckyMerge = {}, worksheet: Excel.Worksheet) {
...
const setBorder = function (luckyBorderInfo: any[], worksheet: Excel.Worksheet) {
...
const setStyleAndValue = function (cellArr: any[], worksheet: Excel.Worksheet) {
...
const fillConvert = function (bg: string) {
  if (!bg) {
    return {};
  }
...
const borderConvert = function (borderType: string | number, style = 1, color = '#000') {
...
function addborderToCell(borders: { [x: string]: { color: any } }, row_index: any, col_index: any) {
  const border = {};
  const luckyExcel = {
    type: {
      l: 'left',
